...
import bit_pytorch.fewshot as fsvim
...
def mktrainval(args, logger):
    ...
    elif args.dataset == "imagenet2012" or args.dataset == "mask":
    ...
    for b, (x, y) in enumerate(data_loader):
        with torch.no_grad():
            ...
            with chrono.measure("eval fprop"):
                ...
                top1, top2 = topk(logits, y, ks=(1, 2))
...
def main(args):
    ...
    savemodel = pjoin(args.logdir, args.name, "bit.pth")
    '''try:
