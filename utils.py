...
def read_arguments():
    ...
    parser.add_argument("--focal", type=int, nargs='+', default=(1500, 1500), help='rootnet focal lenght parameter',
                        dest='focal')
    parser.add_argument("-f", "--framerate", type=int, default=1, help='how many frames you want to skip',
                        dest='framerate')
    ...
    parser.add_argument("--names", type=str, default='./config/coco.names', help='classes file path',
                        dest='names')
    parser.add_argument("-r", "--resize", type=int, nargs='+', default=(1080, 720), help='output video dimension')
    parser.add_argument("--root_weights", type=str, default='./weights/snapshot_19.pth.tar',
                        help='rootnet snapshot file path', dest='rootPath')
    parser.add_argument("-s", "--save", type=str,
                        help='filename output video you want to save. All files will be saved in '
    ...
    parser.add_argument("--tracker_weights", type=str, default='./weights/ckpt.t7',
                        ...
                        dest='trackPath')
    parser.add_argument("video", type=str, help="Video path to perform inference on. If you want to use the "
                                                "camera, insert the corresponding camera number (usually 0)")
